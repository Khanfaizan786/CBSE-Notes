...
class BobDemo {
    ...
    const DB_NAME = 'cbse_notes';
    const DB_USER = 'root';
    const DB_PASSWORD = 'Swezan0724';
    ...
    public function insertBlob($filePath, $mime) {
        ...
        $sql = "INSERT INTO topic_file_sixth(topic_id,mime,data) VALUES(2,:mime,:data)";
...
// test insert pdf
//$blobObj->__construct();
//$blobObj->insertBlob('pdf/faizan final print.pdf',"application/pdf");
